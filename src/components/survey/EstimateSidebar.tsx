...
export async function EstimateSidebar() {
  ...
  return (
    <aside className="w-full lg:w-[360px] xl:w-[400px] shrink-0">
      <div className="flex h-full flex-col overflow-hidden rounded-2xl glass-strong">
        ...
        {/* Contact info — flex-1 so it grows and pushes Google rating to bottom */}
        <div className="flex-1 divide-y divide-white/60 border-t border-white/60 px-7">
          <div className="flex items-start gap-4 py-5">
            ...
            <div>
              <p className="text-[10px] font-bold uppercase tracking-[0.15em] text-ink-400">
                Contact number:
              </p>
              <a
                href={site.phoneHref}
                className="mt-1 block text-base font-semibold text-ink-900 hover:underline"
              >
                {site.phoneDisplay}
              </a>
            </div>
          ...
          <div className="flex items-start gap-4 py-5">
            ...
            <div>
              ...
              <a
                ...
                className="mt-1 block text-base font-semibold text-ink-900 hover:underline break-all"
              >
                {site.email}
              </a>
            </div>
        ...
        {/* Google rating — pinned to the bottom of the sidebar */}
        <div className="flex flex-col items-center border-t border-white/60 px-8 py-7 mt-auto">
          <span
            className="flex text-[28px] font-bold leading-none tracking-tight"
            aria-label="Google"
          >
          ...
          <p className="mt-2.5 font-heading text-base font-extrabold uppercase tracking-widest text-ink-900">
            4.9 Star
          </p>
          <p className="mt-0.5 text-[10px] font-bold uppercase tracking-[0.2em] text-ink-400">
            Customer Rating
          </p>
        </div>
      </div>
