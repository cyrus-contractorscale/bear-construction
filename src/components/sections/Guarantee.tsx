...
export function Guarantee() {
  return (
    <section
      id="guarantee"
      className="scroll-mt-24 bg-[#111] bg-cover bg-center bg-no-repeat py-16 sm:py-20"
      style={{
        backgroundImage:
          "linear-gradient(rgba(0,0,0,0.82), rgba(0,0,0,0.82)), url('https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=2200&q=80')",
      }}
    >
      <Container className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
        <AnimateOnScroll variant="fade-left" className="space-y-6 lg:space-y-8 text-white">
          <div className="inline-flex items-center gap-2.5 rounded-[10px] border border-zinc-700 bg-zinc-900 px-3.5 py-2 text-[12px] font-bold uppercase tracking-[0.2em] text-white">
            <CertificateIcon />
              <span className="text-white">Your Investment, Protected</span>
          </div>
          ...
          <Link
            href="/about"
            className="inline-flex items-center gap-2 rounded-sm bg-white px-6 py-3 text-[13px] font-bold uppercase tracking-widest text-[#1278ce] transition hover:bg-zinc-100"
          >
