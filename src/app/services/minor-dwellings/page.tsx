...
export const metadata: Metadata = {
  title: "Minor Dwellings Auckland | Bear Construction",
  description:
    "Build a minor dwelling in Auckland with Bear Construction. Expert planning, council compliance, and quality builds on your existing section. Free consultation.",
};
    ...
    <>
      ...
      <section className="relative flex min-h-[72vh] items-end overflow-hidden bg-zinc-950 pb-16 pt-32 sm:pb-20 sm:pt-40">
        <Image
          ...
          alt="Bear Construction minor dwellings Auckland"
          fill
          priority
        ...
        <Container className="grid gap-12 lg:grid-cols-2 lg:gap-16 lg:items-center">
          <AnimateOnScroll variant="fade-right">
            <div className="space-y-5">
              <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[#1278ce]/50">Smart Space Solution</p>
          ...
          <AnimateOnScroll variant="fade-left" delay={150}>
            <div className="space-y-4">
              <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[#1278ce]/50">Why Consider Building a Minor Dwelling</p>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {keyPoints.map((point, i) => (
              <AnimateOnScroll key={point.title} variant="fade-up" delay={i * 80}>
                <div className="flex flex-col gap-4 rounded-2xl border border-[#e8edf2] bg-white p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-md hover:shadow-[#1278ce]/8">
                  <span className="text-4xl">{point.icon}</span>
                  <h3 className="text-[17px] font-bold text-[#1278ce]">{point.title}</h3>
