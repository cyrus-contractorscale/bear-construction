...
export const metadata: Metadata = {
  title: "Bathroom Renovations Auckland | Bear Construction",
  description:
    "Transform your bathroom into a stunning sanctuary with Bear Construction. Expert Auckland bathroom renovations — fixed-price contracts, waterproofing certified.",
};
    ...
    <>
      ...
      <section className="relative flex min-h-[72vh] items-end overflow-hidden bg-zinc-950 pb-16 pt-32 sm:pb-20 sm:pt-40">
        <Image
          ...
          alt="Bear Construction bathroom renovations Auckland"
          fill
          priority
