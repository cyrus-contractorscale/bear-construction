...
export const metadata: Metadata = {
  title: "Granny Flats Auckland | Bear Construction",
  description:
    "Build a high-quality granny flat in Auckland with Bear Construction. Fixed-price contracts, council compliance expertise, licensed builders. Free consultation.",
};
    ...
    <>
      ...
      <section className="relative flex min-h-[72vh] items-end overflow-hidden bg-zinc-950 pb-16 pt-32 sm:pb-20 sm:pt-40">
        <Image
          ...
          alt="Bear Construction granny flats Auckland"
          fill
          priority
        ...
        <Container className="grid gap-12 lg:grid-cols-2 lg:gap-16 lg:items-center">
          ...
          <AnimateOnScroll variant="fade-left" delay={150}>
            <div className="space-y-4">
              <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[#1278ce]/50">Benefits of Building a Granny Flat</p>
          ...
          <AnimateOnScroll variant="fade-right">
            <div className="space-y-5">
              ...
              <h2 className="font-[ui-sans-serif,system-ui,sans-serif] text-[40px] font-extrabold leading-[1.08] tracking-tight text-white sm:text-[48px]">
                Why Choose Bear Construction for Your Granny Flat
              </h2>
            ...
            {grannFlatTypes.map((type, i) => (
              <AnimateOnScroll key={type.title} variant="fade-up" delay={i * 80}>
                <div className="flex flex-col gap-4 rounded-2xl border border-[#e8edf2] bg-white p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-md hover:shadow-[#1278ce]/8">
                  ...
                  <h3 className="text-[17px] font-bold text-[#1278ce]">{type.title}</h3>
