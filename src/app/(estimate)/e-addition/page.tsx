...
const faqs = [
  {
    ...
    a: "Our estimate gives you a realistic price range based on your extension type, size, finish level, and current Wellington market rates. It is a budgeting guide before you commit to a formal quote.",
  },
  {
  ...
  },
  {
    ...
    a: "Phil or a team member will reach out within one business day to discuss your extension plans and arrange a free on-site consultation.",
  },
];
