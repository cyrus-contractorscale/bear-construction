...
const faqs = [
  ...
  },
  {
    ...
    a: "Yes — all waterproofing, tiling, fixtures, and fittings are managed by Bear Construction. We use certified waterproofing systems that meet NZ building code requirements.",
  },
  {
    q: "What happens after I submit the form?",
    a: "Phil or a team member will reach out within one business day to discuss your bathroom project and arrange a free consultation.",
  },
];
