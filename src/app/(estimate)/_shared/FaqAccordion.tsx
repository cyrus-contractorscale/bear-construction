    ...
    <div className={`group border-b border-white/10 last:border-0 transition-colors duration-200 ${open ? "bg-white/5" : "hover:bg-white/5"}`}>
      ...
      >
        <div className="flex items-start gap-4">
          <span className="mt-0.5 flex-shrink-0 text-xs font-bold tabular-nums text-[#1278ce]/60">
        ...
        <span className={`mt-0.5 flex-shrink-0 flex h-6 w-6 items-center justify-center rounded-full border border-white/20 transition-all duration-300 ${open ? "border-[#1278ce] bg-[#1278ce] rotate-45" : "group-hover:border-white/40"}`}>
