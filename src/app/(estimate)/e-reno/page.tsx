...
export const metadata = {
  title: "Home Renovation Estimate | Bear Construction",
...
const faqs = [
  {
    ...
    a: "Our estimate gives you a realistic price range based on your renovation scope, finish level, and current Wellington market rates. It is a budgeting guide before you commit to a formal quote.",
  },
  {
  ...
  },
  {
    ...
    a: "Phil or a team member will reach out within one business day to discuss your renovation and arrange a free on-site consultation.",
  },
];
