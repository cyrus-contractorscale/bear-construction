...
export const metadata: Metadata = {
  title: "Why Choose Us | Residential Builders Wellington | Bear Construction",
  description:
    "Discover why Bear Construction is the residential builder Wellington homeowners trust. Backed by 20+ years of local experience, Master Builders, and a 10-Year Ironclad Guarantee.",
