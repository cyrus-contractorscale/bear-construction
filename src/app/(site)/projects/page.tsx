...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.bearconstruction.co.nz/projects",
  },
  openGraph: {
    title: "Our Projects | Bear Construction Wellington",
    description:
      "Explore Bear Construction's recent Wellington projects — recladding, warehouse rebuilds, commercial and residential builds delivered with quality craftsmanship.",
    url: "https://www.bearconstruction.co.nz/projects",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Bear Construction Wellington — Projects",
      },
    ],
  },
};
