...
export const metadata: Metadata = {
  ...
  description:
    "Earthquake-strengthening and full rebuild of a historic Wellington CBD building — modern commercial ground floor and expanded upper apartment.",
  ...
  alternates: {
    canonical: "https://www.bearconstruction.co.nz/projects/103-105-victoria-street",
  },
  openGraph: {
    title: "103–105 Victoria Street Wellington | Bear Construction",
    description:
      "Bear Construction earthquake-strengthened and fully rebuilt this historic Wellington CBD building — new commercial ground floor and a two-bedroom upper apartment.",
    url: "https://www.bearconstruction.co.nz/projects/103-105-victoria-street",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "103–105 Victoria Street", item: "https://www.bearconstruction.co.nz/projects/103-105-victoria-street" },
  ],
};
