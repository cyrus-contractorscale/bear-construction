    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Bear Construction Wellington — Contact Us",
      },
    ],
  },
};
...
const contactPageSchema = {
  ...
  "@type": "ContactPage",
  name: "Contact Bear Construction",
  description: "Get in touch with Bear Construction — independent builders servicing Wellington, Lower Hutt, Upper Hutt, and Porirua.",
  url: "https://www.bearconstruction.co.nz/contact",
  mainEntity: {
    "@type": "LocalBusiness",
