...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.bearconstruction.co.nz/services/home-extensions",
  },
  openGraph: {
    title: "Expert Home Extensions Wellington | Bear Construction",
    description:
      "Bear Construction specialises in home extensions and second-storey additions across Wellington — structural work, council consents, and quality construction managed end to end.",
