...
export const metadata: Metadata = {
  title: "Expert Recladding Wellington | Bear Construction",
  description:
    "Bear Construction specialises in recladding, leaky home repairs, and exterior remediation in Wellington. We manage timber repairs, consents, and construction.",
  keywords: "recladding wellington",
  alternates: {
    canonical: "https://www.bearconstruction.co.nz/services/recladding",
  },
  openGraph: {
    title: "Expert Recladding Wellington | Bear Construction",
    description:
      "Bear Construction specialises in recladding, leaky home repairs, and exterior remediation in Wellington — timber repairs, consents, and full construction managed end to end.",
    url: "https://www.bearconstruction.co.nz/services/recladding",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Recladding Wellington — Bear Construction",
      },
    ],
  },
};
...
const faqs = [
  ...
  },
  {
    ...
    a: "We recommend systems that have proven performance in New Zealand. Treated timber weatherboards remain an excellent, sustainable choice, but we also install advanced fibre cement cladding and modern insulated cladding systems. We will guide you on the best material for your specific aesthetic and maintenance goals.",
  },
  {
...
const serviceSchema = {
  ...
  "@type": "Service",
  name: "Recladding Wellington",
  description: "Recladding and leaky home remediation specialists in Wellington. Bear Construction replaces failing exterior systems and installs premium weathertight cladding.",
  url: "https://www.bearconstruction.co.nz/services/recladding",
  provider: {
    "@type": "LocalBusiness",
...
export default function RecladdingPage() {
  return (
    <>
      <script
        ...
        <Container className="grid gap-12 lg:grid-cols-2 lg:gap-16 lg:items-center">
          <AnimateOnScroll variant="fade-right">
            <div className="space-y-5">
              ...
              <ul className="space-y-4">
                {[
                  "Seeing signs of moisture damage and knowing it is time to secure the structural safety of your biggest asset?",
                  "Dreading the financial risk associated with leaky homes and needing an absolute expert to permanently resolve the underlying issues?",
                  "Looking to modernise an ageing property with a complete exterior renovation Wellington locals trust?",
                ].map((point) => (
                  <li
                    key={point}
          ...
          <AnimateOnScroll variant="fade-left" delay={150}>
            <div className="space-y-5">
              ...
              <p className="text-[15px] text-[#5f7286]">
                Do not commit to tearing off your exterior without a rock-solid plan for the rebuild. Book an initial consultation with us to understand the true costs, timelines, and council requirements for securing your property.
              </p>
            </div>
          </AnimateOnScroll>
        </Container>
          ...
          <AnimateOnScroll variant="fade-right">
            <div className="space-y-6">
              ...
              <div className="space-y-5 text-[17px] leading-[1.65] text-[#4d6277]">
                <p>
                  Executing a flawless house cladding upgrade in Wellington requires a delicate balance between modern engineering and strict compliance. Homes built during the late 1980s to mid-2000s often face systemic vulnerabilities. Resolving these issues means establishing absolute weather-tightness. This is a highly technical process. It demands expert assessment, comprehensive timber remediation, and precise flashing integration to ensure water never breaches the framing again.
                </p>
                <p>
                  The capital&apos;s unpredictable coastal weather presents unique logistical challenges for any major exterior project. High winds and driving rain mean your home needs the ultimate protection. We carefully sequence every stage of the demolition and rebuild. By selecting premium materials and installing modern insulated cladding systems, we significantly improve the house&apos;s thermal efficiency.
                </p>
                <p>
                  Whether you are looking for modern fibre cement cladding, traditional brick veneer, or the classic weatherboard replacement Wellington families love, we ensure your home looks stunning while providing impenetrable moisture control.
                </p>
              </div>
            </div>
          </AnimateOnScroll>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="relative aspect-[3/4] overflow-hidden rounded-2xl">
                <Image
                  ...
                  alt="Bear Construction recladding Wellington"
                  fill
        ...
        <Container className="space-y-14 max-w-[1200px]">
          <AnimateOnScroll variant="fade-up" className="text-center space-y-4">
            ...
            <p className="mx-auto max-w-2xl text-[17px] text-[#5f7286]">
              Stripping the exterior off a house requires absolute site control. We utilise a disciplined 6-step recladding process to maintain safety, weatherproofing, and constant progress on site.
            </p>
          </AnimateOnScroll>
      ...
      >
        <Container className="max-w-[1200px]">
          ...
          <AnimateOnScroll variant="fade-up" delay={200} className="mt-10 text-center">
            <Link
              href="/testimonials"
              className="inline-flex items-center gap-2 rounded-full border border-white/30 px-6 py-3 text-sm font-semibold text-white transition hover:bg-white/10"
            >
              See Our Reviews <span aria-hidden="true">→</span>
            </Link>
          </AnimateOnScroll>
        </Container>
      </section>
          ...
          <AnimateOnScroll variant="fade-right">
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-[17px] leading-[1.65] text-[#4d6277]">
                  Removing the protective layer of your biggest asset requires total trust in your contractor. We operate under a strict internal policy that demands absolute accountability for the safety, weatherproofing, and progress of your site.
                </p>
                <p className="text-[17px] leading-[1.65] text-[#4d6277]">
                  We refuse to accept &ldquo;good enough.&rdquo; We aim for zero defects at handover because we know that true quality lives in the invisible details that keep water out. By prioritising transparent communication and fair pricing, we safeguard your financial security and deliver a robust final result.
                </p>
              </div>
            </div>
          </AnimateOnScroll>
          ...
          <AnimateOnScroll variant="fade-left" delay={100}>
            <div className="relative aspect-[3/4] overflow-hidden rounded-[24px] shadow-xl shadow-zinc-900/10 ring-1 ring-zinc-900/5">
              <Image
                ...
                alt="Bear Construction recladding precision Wellington"
                fill
                className="object-cover"
          ...
          <AnimateOnScroll variant="fade-right">
            <div className="relative aspect-[4/3] overflow-hidden rounded-[24px] shadow-xl shadow-zinc-900/10 ring-1 ring-zinc-900/5">
              <Image
                ...
                alt="Bear Construction 10-year guarantee recladding Wellington"
                fill
                className="object-cover"
                sizes="(min-width: 1024px) 50vw, 100vw"
              />
          ...
          <AnimateOnScroll variant="fade-right">
            <div className="space-y-6">
              ...
              <p className="text-[17px] leading-[1.65] text-white/70">
                Your property deserves a disciplined approach. Remove the risk of poorly managed exterior repairs and start your transformation with total confidence.
              </p>
              <p className="text-[17px] font-semibold text-white">
                Book a Project Consultation to align your vision with a realistic budget and secure the premium protection your home expects.
              </p>
        ...
        <Container className="max-w-[1200px] grid gap-12 lg:grid-cols-2 lg:gap-16 lg:items-center">
          <AnimateOnScroll variant="fade-right">
            <div className="space-y-5">
              ...
              <p className="text-[17px] leading-[1.65] text-[#4d6277]">
                To maintain strict quality control and ensure direct owner involvement on every site, Bear Construction operates within a dedicated 50-minute travel radius from Wellington CBD. We provide expert Recladding services across the following primary locations:
              </p>
      ...
      <section className="bg-white py-16 sm:py-20 border-t border-[#e8edf2]">
        <Container className="max-w-[1200px]">
          <AnimateOnScroll variant="fade-up" className="mb-8 text-center">
            <p className="section-tab mx-auto w-fit mb-4">Related Services</p>
            <h2 className="font-[ui-sans-serif,system-ui,sans-serif] text-[32px] font-extrabold leading-tight tracking-tight text-[#1278ce]">
              Learn More About Our Other Specialist Services
            </h2>
          </AnimateOnScroll>
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
            {relatedServices.map((s, i) => (
              <AnimateOnScroll key={s.label} variant="fade-up" delay={i * 60}>
                <Link
                  href={s.href}
                  className="flex items-center justify-center rounded-xl border border-[#e8edf2] bg-[#f9fafb] px-4 py-4 text-center text-[14px] font-semibold text-[#2d4560] transition hover:border-[#1278ce]/30 hover:bg-[#1278ce]/5 hover:text-[#1278ce]"
                >
                  {s.label}
                </Link>
              </AnimateOnScroll>
