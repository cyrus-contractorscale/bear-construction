...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.bearconstruction.co.nz/services/kitchen-renovations",
  },
  openGraph: {
    title: "Expert Kitchen Renovations Wellington | Bear Construction",
    description:
      "Bear Construction delivers high-end kitchen renovations across Wellington — structural changes, layout design, cabinetry, and complete installation managed end to end.",
    url: "https://www.bearconstruction.co.nz/services/kitchen-renovations",
...
const serviceSchema = {
  ...
  "@type": "Service",
  name: "Kitchen Renovations Wellington",
  description: "Wellington kitchen renovation specialists. Bear Construction redesigns and rebuilds kitchens as part of full home renovations and architectural extensions.",
  url: "https://www.bearconstruction.co.nz/services/kitchen-renovations",
  provider: {
    "@type": "LocalBusiness",
