...
export const metadata: Metadata = {
  title: "Lucinda Place, Glen Eden | Bear Construction",
  description:
    "Explore the Lucinda Place, Glen Eden new build project by Bear Construction, Guman Developer Ltd, and Tarzan Design, comprising four units.",
};
        ...
        <Container className="grid gap-12 lg:grid-cols-2 lg:gap-16 lg:items-center">
          ...
          <AnimateOnScroll variant="fade-left" delay={150}>
            <div className="space-y-5">
              ...
              <p className="text-[17px] leading-[1.65] text-[#4d6277]">
                The Lucinda Place project in Glen Eden is a testament to Bear Construction's dedication to delivering exceptional new build projects. With two of the four units nearing completion, we are excited about the final outcome, promising quality craftsmanship and modern design.
              </p>
              <p className="text-[17px] leading-[1.65] text-[#4d6277]">
